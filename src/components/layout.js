...
export function Navbar(){
  ...
  <div className="container ">
    <Link className="navbar-brand " to="/" ><img src="/shopping.png" alt=""  width="30" height="25" classNameName="me-2 " />Product Management</Link>
...
<img src="/shopping.png" alt=""  width="30" classNameName="me-2 text" />Product
    </div>
  )
}